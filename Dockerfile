...
# QIIME 2 のインストール
RUN wget https://data.qiime2.org/distro/core/qiime2-2024.10-py38-linux-conda.yml && \
    conda env create -n qiime2-2024.10 --file qiime2-2024.10-py38-linux-conda.yml && \
    conda clean -y --all && \
    echo "source activate qiime2-2024.10" >> ~/.bashrc && \
